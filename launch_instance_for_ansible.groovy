...
def createTargetEC2Instance() {
 ...
 def awscmd2 = 'aws cloudformation create-stack --stack-name ansible3 --template-url https://s3.amazonaws.com/venicegeo-devops-dev-gocontainer-project/cf-ansible2.json --region us-west-2'
